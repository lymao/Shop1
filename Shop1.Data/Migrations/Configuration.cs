namespace Shop1.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Shop1.Data.Shop1DbContext>
    {
        ...
        protected override void Seed(Shop1.Data.Shop1DbContext context)
        {
            ...
            //var roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(new Shop1DbContext()));
        ...
        private void CreateConfigTitle(Shop1DbContext context)
        {
        ...
        private void CreatePage(Shop1DbContext context)
        {
        ...
        private void CreateContactDetail(Shop1DbContext context)
        {
            if (context.ContactDetails.Count() == 0)
            {
                try
                {
                    var contactDetail = new Shop1.Model.Models.ContactDetail()
                    {
